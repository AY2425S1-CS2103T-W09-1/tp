...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("HiredFiredPro")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Hiring Manager enters the command to add a candidate.")]),_v(" "),_c('li',[_v("HiredFiredPro adds the candidate.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Hiring Manager enters the command to delete a candidate by specifying the candidate's index in the list.")]),_v(" "),_c('li',[_v("The system deletes the candidate from the list.")]),_v(" "),_c('li',[_v("The system displays a success message.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. The list is empty: The system displays a message indicating there are no candidates to delete.")]),_v(" "),_c('li',[_v("1b. An invalid index is entered: The system displays an error message.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Hiring Manager enters the command to list all candidates.")]),_v(" "),_c('li',[_v("The system retrieves and displays the list of candidates in alphabetical order.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. The list is empty: The system displays a message indicating no candidates are currently listed.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Hiring Manager enters the command with the candidate's name and job title.")]),_v(" "),_c('li',[_v("The system retrieves the candidate's status.")]),_v(" "),_c('li',[_v("The system displays the status of the candidate.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. The specified candidate does not exist: The system displays an error message.")]),_v(" "),_c('li',[_v("1b. The job title or name is missing: The system displays an error message requesting the missing parameter.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Hiring Manager enters the command with the candidate's name and job title.")]),_v(" "),_c('li',[_v("The system changes the candidate's status to either \"hired\" or \"rejected.\"")]),_v(" "),_c('li',[_v("The system displays a success message.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. The specified candidate does not exist: The system displays an error message.")]),_v(" "),_c('li',[_v("2b. The candidate is already marked with the specified status: The system displays an error message.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Sat, 28 Sept 2024, 14:29:21 GMT+8]")])])])}
}];
