...
with(this){return _c('ul',[_c('li',[_v("The project has adapted an ongoing software project for a desktop application (called "),_c('em',[_v("AddressBook")]),_v(") used for managing contact details."),_c('br')]),_v(" "),_c('li',[_v("It was created by created by the "),_c('a',{attrs:{"href":"https://se-education.org"}},[_v("SE-EDU initiative")]),_v(".")]),_v(" "),_c('li',[_v("The source code for the original project can be accessed "),_c('a',{attrs:{"href":"https://github.com/nus-cs2103-AY2425S1/tp"}},[_v("here")]),_v(".")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('strong',[_v("API")]),_v(" of this component is specified in "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-W09-1/tp/blob/master/src/main/java/seedu/address/ui/Ui.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Ui.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-W09-1/tp/blob/master/src/main/java/seedu/address/logic/Logic.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Classes used by multiple components are in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("seedu.hiredfiredpro.commons")]),_v(" package.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The proposed undo/redo mechanism is facilitated by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedHiredFiredPro")]),_v(". It extends "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("HiredFiredPro")]),_v(" with an undo/redo history, stored internally as an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("hiredFiredProStateList")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(". Additionally, it implements the following operations:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedHiredFiredPro#commit()")]),_v(" — Saves the current hiredfiredpro state in its history.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedHiredFiredPro#undo()")]),_v(" — Restores the previous hiredfiredpro state from its history.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedHiredFiredPro#redo()")]),_v(" — Restores a previously undone hiredfiredpro state from its history.")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("These operations are exposed in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" interface as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitHiredFiredPro()")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undoHiredFiredPro()")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#redoHiredFiredPro()")]),_v(" respectively.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 1. The user launches the application for the first time. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedHiredFiredPro")]),_v(" will be initialized with the initial hiredfiredpro state, and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" pointing to that single hiredfiredpro state.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 5")]),_v(" command to delete the 5th person in the hiredfiredpro. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(" command calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitHiredFiredPro()")]),_v(", causing the modified state of the hiredfiredpro after the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 5")]),_v(" command executes to be saved in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("hiredFiredProStateList")]),_v(", and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" is shifted to the newly inserted hiredfiredpro state.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 3. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/David …​")]),_v(" to add a new person. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" command also calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitHiredFiredPro()")]),_v(", causing another modified hiredfiredpro state to be saved into the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("hiredFiredProStateList")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 4. The user now decides that adding the person was a mistake, and decides to undo that action by executing the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" command. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" command will call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undoHiredFiredPro()")]),_v(", which will shift the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" once to the left, pointing it to the previous hiredfiredpro state, and restores the hiredfiredpro to that state.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Saves the entire hiredfiredpro.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement.")]),_v(" "),_c('li',[_v("Cons: May have performance issues in terms of memory usage.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Individual command knows how to undo/redo by\nitself.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Will use less memory (e.g. for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", just save the person being deleted).")]),_v(" "),_c('li',[_v("Cons: We must ensure that the implementation of each individual command are correct.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('a',{attrs:{"href":"https://ay2425s1-cs2103t-w09-1.github.io/tp/Documentation.html"}},[_v("Documentation guide")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"https://ay2425s1-cs2103t-w09-1.github.io/tp/Testing.html"}},[_v("Testing guide")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"https://ay2425s1-cs2103t-w09-1.github.io/tp/Logging.html"}},[_v("Logging guide")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"https://ay2425s1-cs2103t-w09-1.github.io/tp/Configuration.html"}},[_v("Configuration guide")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"https://ay2425s1-cs2103t-w09-1.github.io/tp/DevOps.html"}},[_v("DevOps guide")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("has a need to manage a significant number of candidates across various job roles")]),_v(" "),_c('li',[_v("has a need to view and filter candidate lists quickly based on various categories")]),_v(" "),_c('li',[_v("requires tools to schedule interviews, assign interviewers and update the outcome of the interview")]),_v(" "),_c('li',[_v("requires tools to efficiently track candidate progress and make hiring decisions")]),_v(" "),_c('li',[_v("prefers desktop apps for recruitment tracking over web or mobile applications")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": Provides streamlined access to candidate information allowing users to track their progress,\ncompare candidates, and make informed hiring decisions with efficient CLI commands, faster than a typical\nmouse/GUI driven app.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Priorities: High (must have) - "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Essential")]),_v(", Medium (nice to have) - "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Typical")]),_v(", Low (unlikely to have) - "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Novel")])])}
},function anonymous(
) {
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_v("Essential")]),_v(" "),_c('td',[_v("Interviewer")]),_v(" "),_c('td',[_v("add candidates")]),_v(" "),_c('td',[_v("keep track of current candidates")])]),_v(" "),_c('tr',[_c('td',[_v("Essential")]),_v(" "),_c('td',[_v("Interviewer")]),_v(" "),_c('td',[_v("delete candidates")]),_v(" "),_c('td',[_v("keep track of current candidates")])]),_v(" "),_c('tr',[_c('td',[_v("Essential")]),_v(" "),_c('td',[_v("Hiring Manager")]),_v(" "),_c('td',[_v("view a list of candidates")]),_v(" "),_c('td',[_v("quickly assess who has applied for the position")])]),_v(" "),_c('tr',[_c('td',[_v("Essential")]),_v(" "),_c('td',[_v("Hiring Manager")]),_v(" "),_c('td',[_v("mark candidates as \"hired\" or \"rejected\"")]),_v(" "),_c('td',[_v("finalize the hiring process")])]),_v(" "),_c('tr',[_c('td',[_v("Essential")]),_v(" "),_c('td',[_v("Hiring Manager")]),_v(" "),_c('td',[_v("see the current status of a candidate (e.g. shortlisted, rejected)")]),_v(" "),_c('td',[_v("track their progress")])]),_v(" "),_c('tr',[_c('td',[_v("Typical")]),_v(" "),_c('td',[_v("Interviewer")]),_v(" "),_c('td',[_v("see candidates’ programming languages")]),_v(" "),_c('td',[_v("ensure that they have sufficient programming knowledge based on company needs")])]),_v(" "),_c('tr',[_c('td',[_v("Typical")]),_v(" "),_c('td',[_v("Interviewer")]),_v(" "),_c('td',[_v("assign an interview score to a specific candidate")]),_v(" "),_c('td',[_v("objectively evaluate their performance across multiple criteria")])]),_v(" "),_c('tr',[_c('td',[_v("Typical")]),_v(" "),_c('td',[_v("Interviewer")]),_v(" "),_c('td',[_v("attach files (resumes, portfolios) to a candidate's profile")]),_v(" "),_c('td',[_v("have all relevant documents in one place")])]),_v(" "),_c('tr',[_c('td',[_v("Typical")]),_v(" "),_c('td',[_v("Hiring Manager")]),_v(" "),_c('td',[_v("sort candidates according to alphabetical order")]),_v(" "),_c('td',[_v("easily pick out the potential candidates")])]),_v(" "),_c('tr',[_c('td',[_v("Typical")]),_v(" "),_c('td',[_v("Hiring Manager")]),_v(" "),_c('td',[_v("search for candidates based on keywords (skills, position etc.)")]),_v(" "),_c('td',[_v("quickly find the right profiles")])])])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"use-case-1-add-candidate-to-shortlist"}},[_v("Use Case 1: Add Candidate to Shortlist"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-1-add-candidate-to-shortlist","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Actor")]),_v(": Hiring Manager")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Main Success Scenario")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Hiring Manager enters the command to add a candidate.")])]),_v(" "),_c('li',[_c('p',[_v("HiredFiredPro adds the candidate.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. HiredFiredPro detects an error in the entered data.\n"),_c('ul',[_c('li',[_v("1a1. HiredFiredPro requests for the correct data.")]),_v(" "),_c('li',[_v("1a2. Hiring Manager enters new data.")]),_v(" "),_c('li',[_v("Steps 1a1-1a2 are repeated until the data entered are correct.")]),_v(" "),_c('li',[_v("Use case resumes from step 2.")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"use-case-2-delete-candidate-from-shortlist"}},[_v("Use Case 2: Delete Candidate from Shortlist"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-2-delete-candidate-from-shortlist","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Actor")]),_v(": Hiring Manager")])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Hiring Manager enters the command to delete a candidate by specifying the candidate's index in the list.")])]),_v(" "),_c('li',[_c('p',[_v("HiredFiredPro deletes the candidate from the list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty")]),_v(" "),_c('ul',[_c('li',[_v("1a1. HiredFiredPro displays an error message\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1b. An invalid index is entered:")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. HiredFiredPro displays an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"use-case-3-view-candidate-list"}},[_v("Use Case 3: View Candidate List"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-3-view-candidate-list","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Actor")]),_v(": Hiring Manager")])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Hiring Manager enters the command to list all candidates.")])]),_v(" "),_c('li',[_c('p',[_v("HiredFiredPro retrieves and displays the list of candidates in alphabetical order.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"use-case-4-view-candidate-status"}},[_v("Use Case 4: View Candidate Status"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-4-view-candidate-status","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Actor")]),_v(": Hiring Manager")])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Hiring Manager enters the command with the candidate's name and job title.")])]),_v(" "),_c('li',[_c('p',[_v("HiredFiredPro displays the status of the candidate.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. The specified candidate does not exist\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. HiredFiredPro displays an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_v("1b. The job title or name is missing\n"),_c('ul',[_c('li',[_c('p',[_v("1b1. HiredFiredPro displays an error message requesting the missing parameter.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"use-case-5-mark-candidate-status-as-hired-or-rejected"}},[_v("Use Case 5: Mark Candidate Status as Hired or Rejected"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-5-mark-candidate-status-as-hired-or-rejected","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Actor")]),_v(": Hiring Manager")])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Hiring Manager enters the command with the candidate's name and job title.")])]),_v(" "),_c('li',[_c('p',[_v("HiredFiredPro changes the candidate's status to either \"hired\" or \"rejected.\"")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The specified candidate does not exist")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. HiredFiredPro displays an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("2b. The candidate is already marked with the specified status")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. HiredFiredPro displays an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"use-case-6-sort-list-of-candidates-in-ascending-descending-order"}},[_v("Use Case 6: Sort list of candidates in ascending/descending order"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-6-sort-list-of-candidates-in-ascending-descending-order","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Actor")]),_v(": Hiring Manager")])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Hiring Manager enters the command with the either 'a' for ascending or 'd' for descending order.")])]),_v(" "),_c('li',[_c('p',[_v("HiredFiredPro sorts the list of candidates in the specified order.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. Hiring Manager does not input either 'a' or 'd'\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. HiredFiredPro displays an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_v("1b. Hiring Manager inputs other characters other than 'a' or 'd' (eg 'sort x')\n"),_c('ul',[_c('li',[_c('p',[_v("1b1. HiredFiredPro displays an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Setup instructions should be clear and simple, allowing users to get the app running within 5 minutes without installations.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 candidates without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("Commands should be intuitive and easy to remember, minimizing the learning curve for new users.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("Should respond to user input commands within 1 second for optimal usability.")]),_v(" "),_c('li',[_v("Should provide clear error messages and feedback for invalid input, allowing easy debugging for non-technical users.")]),_v(" "),_c('li',[_v("Sensitive information, like candidate emails and phone numbers, should be stored securely and not exposed in error logs or publicly accessible files.")]),_v(" "),_c('li',[_v("The application interface should be adaptable to different screen sizes and resolutions, ensuring usability on both standard and high-definition displays.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Command-Line Interface (CLI)")]),_v(": A text-based interface where users input typed commands to perform specific tasks")]),_v(" "),_c('li',[_c('strong',[_v("Graphical user interface (GUI)")]),_v(": A graphical interface where users interact with graphical elements to perform specific tasks")]),_v(" "),_c('li',[_c('strong',[_v("Debugging")]),_v(": The process of identifying and correcting errors or bugs to perform an intended function.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Adding a candidate to HiredFiredPro")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Adib j/Developer p/12345678 e/example@example i/1")]),_c('br'),_v("\nExpected: New candidate will be added at the end of the list ie. if there are 6 people in the list, he will be 7"),_c('sup',[_v("th"),_c('sup')])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Adib p/12345678 e/example@example i/1")]),_c('br'),_v("\nExpected: Error details shown in the result panel.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Adib j/Developer p/phone_number e/example@example i/100")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (invalid parameters for certain fields)"),_c('br'),_v("\nExpected: Similar to previous.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect add commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add i/1")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v("(missing one or more compulsory fields)"),_c('br'),_v("\nExpected: Similar to previous.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Adib j/Developer p/12345678 e/example@example i/1 t/hired t/reJecteD t/Pending")]),_v(" (adding additional status tags)\nExpected: The additional status tags are omitted and a default \"pending\" status tag still remains.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Dealing with missing data folder.")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Open the folder where HiredFiredPro.jar is located.")])]),_v(" "),_c('li',[_c('p',[_v("Data folder containing json file does not exist.")])]),_v(" "),_c('li',[_c('p',[_v("Upon making any changes to HiredFiredPro, data folder with json file will be created with updated information.")])])])]),_v(" "),_c('li',[_c('p',[_v("Deleting existing HiredFiredPro.json file in existing data folder.")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Open the folder where HiredFiredPro.jar is located.")])]),_v(" "),_c('li',[_c('p',[_v("Click into the data folder and delete the existing json file inside. There should only be one file in the data folder")])]),_v(" "),_c('li',[_c('p',[_v("Upon launching HiredFiredPro, our sample data of 6 people will be shown. Changes made up to that point will be discarded.")])])])]),_v(" "),_c('li',[_c('p',[_v("Saving data after changes are made.")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: HiredFiredPro should be opened.")])]),_v(" "),_c('li',[_c('p',[_v("Make any changes (e.g "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 1")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_v("Close the app.")])]),_v(" "),_c('li',[_c('p',[_v("Open the HiredFiredPro.json file which would be in the same folder as your jar file. "),_c('br')])]),_v(" "),_c('li',[_c('p',[_v("All changes made are reflected in the json file.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"viewing-candidates"}},[_v("Viewing Candidates"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#viewing-candidates","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Viewing a candidate while all candidates are being shown")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all candidates using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple candidates in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view n/Adib j/Developer")]),_c('br'),_v("\nExpected: Candidate with their details will be shown on the display panel.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view n/Adib")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (missing compulsory fields)"),_c('br'),_v("\nExpected: No candidate displayed on display panel. Error details shown in the result panel.")])])])]),_v(" "),_c('li',[_c('p',[_v("Viewing a candidate while no candidates are being shown")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all candidates using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find xxx")]),_v(" where xxx is a name not existing in current candidates list. Multiple candidates existing.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view n/Adib j/Developer")]),_c('br'),_v("\nExpected: No candidate displayed on display panel. Error details shown in the result panel.")])])])])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Mon, 11 Nov 2024, 22:52:34 GMT+8]")])])])}
}];
