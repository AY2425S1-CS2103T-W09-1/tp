...
with(this){return _c('h2',{attrs:{"id":"use-case-6-sort-list-of-candidates-in-ascending-descending-order"}},[_v("Use Case 6: Sort list of candidates in ascending/descending order"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-6-sort-list-of-candidates-in-ascending-descending-order","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Actor")]),_v(": Hiring Manager")])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Command Example")]),_v(":"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort a")]),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort d")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 7 Nov 2024, 15:16:48 GMT+8]")])])])}
}];
